...
all:
	...
	ssh $(CUSER)@$(CMACH) 'cd /tmp; rfcdiff draft-ietf-core-dev-urn-03.txt draft-ietf-core-dev-urn.txt'
	...
	scp $(CUSER)@$(CMACH):/tmp/draft-ietf-core-dev-urn-from--03.diff.html .
