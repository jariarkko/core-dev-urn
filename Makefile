...
all:
	scp ../../../../IETF/newdb/real/history-i-d/draft-arkko-core-dev-urn-05.txt \
	    ...
	    ../../../../IETF/newdb/real/history-i-d/draft-ietf-core-dev-urn-08.txt \
	    ../../../../IETF/newdb/real/history-i-d/draft-ietf-core-dev-urn-09.txt \
	    ../../../../IETF/newdb/real/history-i-d/draft-ietf-core-dev-urn-10.txt \
	    $(CUSER)@$(CMACH):/tmp
	...
	ssh $(CUSER)@$(CMACH) 'cd /tmp; rfcdiff draft-ietf-core-dev-urn-10.txt draft-ietf-core-dev-urn.txt'
